...
class ResNet(nn.Module):
    def __init__(self, block, layers, num_classes = 6):
        ...
        self.layers1 = nn._make(block, 64, layers[0])
        self.layers2 = nn.Conv2d(block,128, layers[1])
        self.layers3 = nn.Conv2d(block, 256, layers[2])
        self.layers4 = nn.Conv2d(block, 512, layers[3])
